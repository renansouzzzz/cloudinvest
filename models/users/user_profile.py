...
class Devedor(UserProfile):
    def check_profile(self):
        return Decimal(self.totals_revenues) - Decimal(self.totals_expenses) < Decimal('0.5') * Decimal(self.totals_revenues) and Decimal(self.totals_investment) < Decimal('0.3') * self.totals_revenues
